...
Copyright 2023 Kasidit Chanchio 
...
<p>
  หลังจากนั้นให้ cd เข้าสู่ openstack-antelope-basic-installer และลิสต์ชื่อไฟล์และสับไดเรคทอรี
<pre>
On controller: 
$ cd openstack-antelope-basic-installer/
$ ls
...
On controller: 
$ pwd
/home/openstack/openstack-antelope-basic-installer
...
<p>
แกล๊นซ์ (glance) (หรือ โอเพ่นสแตค อิมเมจ) (OpenStack Image) เป็นซอฟต์แวร์คอมโพเน้นของโอเพ่นสแตคที่ทำหน้าที่เก็บ เทมแพลต (Template) ของดิสค์อิมเมจของระบบปฏิบัติการที่จะใช้เป็นเกสท์โอเอส (Guest OS) ของวีเอ็ม ยกตัวอย่างเช่นถ้าผู้ติดตั้งต้องการให้ระบบโอเพ่นสแตคสามารถรันวีเอ็มที่มีเกสโอเอสเป็น วินโดวส์ 10 (Windows 10) หรือ เรดแฮท เอนเตอร์ไพร์ซลินุกส์ (Redhat Enterprise Linux) หรือ อูบุนตู เวอร์ชั่น 22.04 เป็นต้น ผู้ติดตั้งจะต้องนำเข้าเทมเพลตของดิสค์อิมเมจของเกสโอเอสเหล่านั้นในระบบแกล๊นซ์ 
<p>
